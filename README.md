...
| config.json の読み込み・バリデーション | `ConfigLoader` |
...
ComfyUILibs/
  ...
  Models/
    WorkflowConfig.cs         # config.json モデル
  ...
  Services/
    ...
    ComfyUIClient.cs          # ComfyUI REST API + WebSocket クライアント
    ConfigLoader.cs           # config.json 読み込み・バリデーション
...
| `Services/ComfyUIClientTests.cs` | 9 | FakeHttpMessageHandler によるモック |
