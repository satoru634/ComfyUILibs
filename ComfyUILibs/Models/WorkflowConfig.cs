...
namespace ComfyUILibs.Models
{
    ...
    public class WorkflowConfig
    {
        ...
        /// <summary>
        /// WD Timm Tagger の設定。このセクションが存在する場合のみ <see cref="Wd14TaggerRunner"/> が利用できる。
        /// <see cref="WdV3TimmTaggerRunner"/>（ローカルプロセス版、wdv3_timm.exe は
        /// <see cref="Services.WdV3TimmPaths"/> の固定パスから起動する）もモデル名・しきい値をこのセクションから
        /// 共用する（<see cref="Services.WdV3TimmModelMap"/> で model_name を --model 値へ変換する）。
        /// </summary>
